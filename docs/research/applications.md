...
В ICA/BSS часто строят набор матриц (ковариации на лагах, кумулянты 4-го порядка и т.п.), которые в идеале становятся диагональными в базисе источников. Например, JADE формулируется как поиск ортогональной матрицы вращения, которая **совместно диагонализует** кумулянтные матрицы.
...
|---|---|---:|---|---|---|
| ICA/BSS (EEG/аудио/телеком) | 2 матрицы моментов (ковариаци�� на лагах / кумулянты) | 16–256 | Да (батч/окна) | Да (EEG датасеты → ковариации), синтетика ICA | H |
